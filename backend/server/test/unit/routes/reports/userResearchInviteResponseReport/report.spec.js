...
const userResearchInviteResponseReport = require('../../../../../routes/reports/userResearchInviteResponseReport/report');

describe('/server/routes/reports/userResearchInviteResponseReport/report', () => {
  describe('userResearchInviteResponseReport()', () => {
    afterEach(() => {
      sinon.restore();
    });
