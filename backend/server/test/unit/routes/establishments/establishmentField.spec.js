  ...
  describe('server/routes/establishments/getEstablishmentField', () => {
    ...
    describe('/updateEstablishmentFieldWithAudit', () => {
      const mockRequest = {
        ...
        establishmentId: establishmentId,
        username: 'user',
        body: { property: 'EmployerType', objectToUpdate: { employerType: { value: 'Private Sector' } } },
      };
      ...
      it('should update the property and return a 200 status', async () => {
        ...
        expect(establishmentRecord.load).to.have.been.calledWith(req.body.objectToUpdate);
