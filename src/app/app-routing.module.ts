...
import { PrimaryWorkplacePermissionGuard } from '@core/guards/primary-workplace-permission/primary-workplace-permission.guard';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [PrimaryWorkplacePermissionGuard],
        data: {
