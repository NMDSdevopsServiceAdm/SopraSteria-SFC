...
export class EstablishmentService {
  ...
  getCapacity(all = false) {
    return this.http
      .get<any>(`/api/establishment/${this.establishmentId}/capacity?all=${all}`, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
  ...
  postCapacity(capacities) {
    ...
    return this.http
      .post<any>(`/api/establishment/${this.establishmentId}/capacity`, data, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
        catchError(this.httpErrorHandler.handleHttpError)
      );
  ...
  getJobs() {
    return this.http
      .get<any>(`/api/establishment/${this.establishmentId}/jobs`, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
        map(res => res.jobs),
        catchError(this.httpErrorHandler.handleHttpError)
  ...
  postVacancies(vacancies) {
    ...
    return this.http
      .post<any>(`/api/establishment/${this.establishmentId}/jobs`, data, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
        catchError(this.httpErrorHandler.handleHttpError)
      );
  ...
  getStaff() {
    return this.http
      .get<any>(`/api/establishment/${this.establishmentId}/staff`, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
  ...
  postStaff(numberOfStaff) {
    return this.http
      .post<any>(
        `/api/establishment/${this.establishmentId}/staff/${numberOfStaff}`,
        null,
  ...
  getSharingOptions() {
    return this.http
      .get<ShareOptionsResponse>(`/api/establishment/${this.establishmentId}/share`, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
        catchError(this.httpErrorHandler.handleHttpError)
      );
  ...
  postSharingOptions(shareOptions: SharingOptionsModel) {
    ...
    return this.http
      .post<any>(`/api/establishment/${this.establishmentId}/share`, postBody, EstablishmentService.getOptions())
      .pipe(
        debounceTime(500),
        catchError(this.httpErrorHandler.handleHttpError)
      );
  ...
  getLocalAuthorities() {
    return this.http
      .get<ShareWithLocalAuthorityResponse>(
  ...
  getEmployerType() {
    return this.http
      .get<EmployerTypeResponse>(
        `/api/establishment/${this.establishmentId}/employerType`,
        EstablishmentService.getOptions()
      )
      .pipe(
        debounceTime(500),
  ...
  getAllServices() {
    return this.http
      .get<ServicesModel>(
        `/api/establishment/${this.establishmentId}/services?all=true`,
        EstablishmentService.getOptions()
      )
      .pipe(
        debounceTime(500),
  ...
  getCurrentServices() {
    return this.http
      .get<ServicesModel>(
        `/api/establishment/${this.establishmentId}/services?all=false`,
        EstablishmentService.getOptions()
      )
      .pipe(
        debounceTime(500),
  ...
  postOtherServices(obj: PostServicesModel) {
    return this.http
      .post<PostServicesModel>(
        `/api/establishment/${this.establishmentId}/services`,
        obj,
        EstablishmentService.getOptions()
      )
      .pipe(
