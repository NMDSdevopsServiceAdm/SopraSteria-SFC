...
export class CqcStatusChangeService {
  ...
  public getCqcStatusChange(): Observable<CqcStatusChanges[]> {
    console.log("calling /api/admin/cqc-status-change/");
  ...
  public CqcStatusChangeApproval(data: object) {
    return this.http.post<any>('/api/admin/cqc-approval/', data);
  }

  public CqcStatusChange() {
    return this.http.post<any>('/api/approvals/cqc-status-change/', null);
  }
}
