...
describe('RejectedRegistrationRequestsComponent', () => {
  ...
  //   expect(workplace1Name).toBeFalsy();
  //   expect(workplace1Postcode).toBeFalsy();
  //   expect(workplace1ParentId).toBeFalsy();
  //   expect(workplace1Status).toBeFalsy();
  //   expect(workplace1Created).toBeFalsy();

  //   expect(workplace2Name).toBeFalsy();
  //   expect(workplace2Postcode).toBeFalsy();
  //   expect(workplace2Status).toBeFalsy();
  //   expect(workplace2Created).toBeFalsy();

  //   expect(workplace3Name).toBeTruthy();
  // });
});
