...
import { DataAreaHeaderComponent } from './data-area-header.component';
...
describe('DataAreaHeaderComponent', () => {
  const setup = async (
    tab = 'home',
    updateDate = false,
    canAddWorker = true,
    ...
    const { fixture, getByTestId, queryByTestId, getByText, queryByText } = await render(DataAreaHeaderComponent, {
