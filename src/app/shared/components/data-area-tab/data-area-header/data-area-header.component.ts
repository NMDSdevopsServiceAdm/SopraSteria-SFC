...
@Component({
  selector: 'app-data-area-header',
  templateUrl: './data-area-header.component.html',
  styleUrls: ['./data-area-header.component.scss'],
})
export class DataAreaHeaderComponent implements OnInit {
