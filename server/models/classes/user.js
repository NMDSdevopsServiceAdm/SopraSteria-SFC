...
class User {
  ...
  // Maximum user types
  static get MAX_EDIT_PARENT_USERS() {
    return 3;
  }
  static get MAX_READ_PARENT_USERS() {
    return 20;
  }
  static get MAX_EDIT_SINGLE_USERS() {
    return 3;
  }
  static get MAX_READ_SINGLE_USERS() {
    return 3;
  }
  ...
  async load(document) {
    try {
      ...
      throw new UserExceptions.UserJsonException(err, null, 'Failed to load User from JSON');
    }
    return this.isValid();
  }
