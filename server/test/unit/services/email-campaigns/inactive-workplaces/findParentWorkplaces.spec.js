...
describe('server/routes/admin/email-campaigns/inactive-workplaces/findParentWorkplaces', () => {
  ...
  it("should only return parent workplaces of subs that haven't logged in and havent't been updated for at least 6 months", async () => {
    sinon.stub(models.sequelize, 'query').returns([
      {
        EstablishmentID: 1,
        NameValue: 'Test Name',
      ...
      },
      {
        ...
        LastUpdated: endOfLastMonth.clone().subtract(3, 'months').format('YYYY-MM-DD'),
        DataOwner: 'Workplace',
        PrimaryUserName: 'Test 3 Person',
        PrimaryUserEmail: 'test3@example.com',
      },
      {
        EstablishmentID: 6,
        NameValue: 'Workplace 3 Name',
        ParentID: 3,
        IsParent: false,
        NmdsID: 'H0205239',
        LastLogin: endOfLastMonth.clone().subtract(3, 'months').format('YYYY-MM-DD'),
