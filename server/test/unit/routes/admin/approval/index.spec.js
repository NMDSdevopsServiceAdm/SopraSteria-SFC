...
describe.skip('admin/Approval route', () => {
  ...
  describe('approving a new user', () => {
    ...
    it('should return status 500 if login update throws exception when approving a new user', async () => {
      // Arrange
      testLogin.update = () => {
        throw 'Error';
      };
    ...
    it('should return status 500 if workplace update throws exception when approving a new user', async () => {
      // Arrange
      testWorkplace.update = () => {
        throw 'Error';
      };
  ...
  describe('rejecting a new user', () => {
    ...
    it('should return status 500 if it is not possible to delete a user when rejecting a new user', async () => {
      // Arrange
      testUser.destroy = () => {
        return false;
      };
    ...
    it('should return status 500 if it is not possible to delete a workplace when rejecting a new user', async () => {
      // Arrange
      testWorkplace.destroy = () => {
        return false;
      };
