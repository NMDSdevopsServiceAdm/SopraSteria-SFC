...
const { updateStatus } = require('../../../../../routes/admin/cqc-status-change/updateStatus');
...
describe('updateStatus', () => {
  ...
  it('should return 400 when the approval cannot be found', async () => {
    ...
    await updateStatus(req, res);
    const expectedResponse = { error: 'CQC status change request could not be found' };
  ...
  it('should return 400 if the approval is already being reviewed by someone else', async () => {
    ...
    await updateStatus(req, res);
    const expectedResponse = { error: 'This CQC status change request is already being reviewed' };
