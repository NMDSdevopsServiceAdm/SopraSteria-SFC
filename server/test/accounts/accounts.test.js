  ...
  beforeAll(async () => {
    ...
    if (registration) {
      const adminLogin = await apiEndpoint
        ...
        .expect('Content-Type', /json/)
        .expect(200);
      console.log(adminLogin.headers.authorization);
...
describe('Change User Details', () => {
  ...
  it('should return a 401 error when requesting a users establishments with no authorization token passed', async () => {
  ...
  it('should return a 403 error when requesting a users establishments as the incorrect user', async () => {
    await apiEndpoint
  ...
  it('should return a 404 error when no user found', async () => {
  ...
  it('should return a 403 error when not authorised to request another establishment\'s user', async () => {
    await apiEndpoint
  ...
  it('should return a 401 error when a user is not authenicated', async () => {
    await apiEndpoint
      .get(
        `/user/establishment/${establishmentUid}/${encodeURIComponent(
          '28a401f5-99a6-41c0-b685-91950f90e8f6'
