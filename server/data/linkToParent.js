...
const checkLinkToParentUidQuery = `
  select  notify."notificationContentUid", link."ApprovalStatus"  as "approvalStatus"
  from cqc."NotificationsEstablishment" as notify
  JOIN cqc."LinkToParent" as link on notify."notificationContentUid" =  link."LinkToParentUID"
