...
const SectionId = {
  ...
  VacanciesAndTurnover: 'vacancies-and-turnover-section',
...
describe('NewWorkplaceSummaryComponent', () => {
  ...
  it('should render all the sections', async () => {
    ...
    expect(getByTestId(SectionId.Workplace)).toBeTruthy();
  ...
  describe('workplace-section', () => {
    describe('CQC Location ID', () => {
      it('should render the locationID and a Change link if the workplace is regulated', async () => {
        ...
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/regulated-by-cqc`,
        );
    ...
    describe('Number of staff', () => {
      it('should render the number of staff and a Change link without conditional classes', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/total-staff`,
        );
    ...
    describe('Employer type', () => {
      it('should render a dash and an Add link if there is not a value for employer type', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/type-of-employer`,
        );
  ...
  describe('services section', () => {
    ...
    describe('Main service', () => {
      ...
      it('should show the Change link when there is a main service', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/main-service-cqc`,
        );
      });
    ...
    describe('Other services', () => {
      it('should show dash and have Add information button on when otherServices value is null', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/other-services`,
        );
    ...
    describe('Service capacity', () => {
      ...
      it('should show dash and have Add information button if there are allServiceCapacities and showAddWorkplaceDetailsBanner is false', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/capacity-of-services`,
        );
    ...
    describe('Service users', () => {
      it('should show dash and have Add information button on when serviceUsers is an empty array', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/service-users`,
        );
    ...
    describe('Carry out delegated healthcare activities', () => {
      ...
      it('should show dash and have Add information button when is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/staff-do-delegated-healthcare-activities`,
        );
      ...
      describe('mainService canDoDelegatedHealthcareActivities is true', () => {
        ...
        describe('staffDoDelegatedHealthcareActivities is "Yes"', () => {
          it('should show "Not known" and a change link when Don`t know is answered', async () => {
            ...
            expect(link).toBeTruthy();
            expect(link.getAttribute('href')).toEqual(
              `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/what-kind-of-delegated-healthcare-activities`,
            );
            expect(knowWhatDelegatedHealthcareActivitiesRow).toBeTruthy();
          });
    ...
    describe('Offer sleep-ins', () => {
      ...
      it('should not show an add link when there is no canEditEstablishment permission', async () => {
        ...
        const link = within(offerSleepInsRow).queryByText('Add');
      ...
      it('should not show a change link when there is no canEditEstablishment permission', async () => {
        ...
        const link = within(offerSleepInsRow).queryByText('Change');
      ...
      it('should show should show "-" and an add link when offerSleepIn is null', async () => {
        ...
        const link = within(offerSleepInsRow).queryByText('Add');
        const answer = within(offerSleepInsRow).queryByText('-');

        expect(answer).toBeTruthy();
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/workplace-offer-sleep-ins`,
        );
        expect(offerSleepInsRow).toBeTruthy();
      });

      const offerSleepInValues = [
        { database: 'Yes', formatted: 'Yes' },
        { database: 'No', formatted: 'No' },
        { database: "Don't know", formatted: 'Not known' },
      ];
      offerSleepInValues.forEach((offerSleepInValue) => {
        it(`should display the answers with a change link when offerSleepIn is ${offerSleepInValue.database}`, async () => {
          const { component, fixture, getByTestId } = await setup({
            establishment: {
              mainService: { payAndPensionsGroup: 1 },
            },
          ...
          const link = within(offerSleepInsRow).queryByText('Change');
          const answer = within(offerSleepInsRow).queryByText(offerSleepInValue.formatted);
  ...
  describe('Vacancies and turnover section', () => {
    ...
    describe('Current staff vacancies', () => {
      it('should show dash and have Add information button on when starters is null', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/update-vacancies`,
        );
    ...
    describe('New starters', () => {
      ...
      it('should show dash and have Add information button on when starters is null', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/update-starters`,
        );
    ...
    describe('Staff leavers', () => {
      ...
      it('should show dash and have Add information button on when leavers is null', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/update-leavers`,
        );
  ...
  describe('Pay and benefits section', () => {
    ...
    describe('statutory sick pay', () => {
      it('should show dash and have Add information button on statutory sick pay row when sickPay is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/benefits-statutory-sick-pay`,
        );
    ...
    describe('number of days leave', () => {
      it('should show dash and have Add information button on number of days leave row when careWorkersLeaveDaysPerYear is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/staff-benefit-holiday-leave`,
        );
    ...
    describe('Cash loyalty bonus', () => {
      it('should show dash and have Add information button on Cash loyalty bonus row when careWorkersCashLoyaltyForFirstTwoYears is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/cash-loyalty`,
        );
  ...
  describe('Staff development section', () => {
    it('should not show the section if showAddWorkplaceDetailsBanner is true', async () => {
      ...
      expect(queryByTestId(SectionId.StaffDevelopment)).toBeFalsy();
    });
    ...
    describe('Repeat training', () => {
      it('should show dash and have Add information button on  Repeat Training row when doNewStartersRepeatMandatoryTrainingFromPreviousEmployment is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/staff-recruitment-capture-training-requirement`,
        );
    ...
    describe('Accept care certificate', () => {
      it('should show dash and have Add information button on accept care certificate row when wouldYouAcceptCareCertificatesFromPreviousEmployment is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/accept-previous-care-certificate`,
        );
    ...
    describe('Care workforce pathway aware', () => {
      it('should show dash and have Add information button when is set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/care-workforce-pathway-awareness`,
        );
    ...
    describe('Using the care workforce pathway', () => {
      ...
      it('should show a dash "-" and "Add" button if not yet answered the CWP use question', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/care-workforce-pathway-use`,
        );
  ...
  describe('Permissions section', () => {
    describe('Data sharing', () => {
      it('should show dash and have Add information button on Data sharing when cqc and localAuthorities set to null (not answered)', async () => {
        ...
        expect(link).toBeTruthy();
        expect(link.getAttribute('href')).toEqual(
          `/workplace/${component.workplace.uid}/workplace-data/workplace-summary/sharing-data`,
        );
