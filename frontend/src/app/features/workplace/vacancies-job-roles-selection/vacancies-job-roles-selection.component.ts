...
import { JobRoleSelectionDirective } from '../vacancies-and-turnover/job-role-selection.directive';

@Component({
  selector: 'app-vacancies-job-roles-selection',
  templateUrl: '../vacancies-and-turnover/job-role-selection.html',
})
export class VacanciesJobRolesSelectionComponent extends JobRoleSelectionDirective implements OnInit, OnDestroy {
