...
import {
  WorkplaceNotFoundDirective,
} from '@shared/directives/create-workplace/workplace-not-found/workplace-not-found.directive';
...
export class WorkplaceNotFoundComponent extends WorkplaceNotFoundDirective {
  constructor(
    ...
    super(establishmentService, formBuilder, backLinkService, errorSummaryService, registrationService, router, route);
  }
