...
describe('change data owner', () => {
  ...
  it('should make a request to become a data owner and then cancel the request', () => {
  ...
  it('should make a request to become a data owner and the subsidiary rejects the request', () => {
    cy.get(`[data-cy="${subsidiaryWorkplaceName}"]`).contains('Change data owner').click();
  ...
  it('should make a request to become a data owner and the subsidiary approves the request', () => {
    cy.get(`[data-cy="${subsidiaryWorkplaceName}"]`).contains('Change data owner').click();
