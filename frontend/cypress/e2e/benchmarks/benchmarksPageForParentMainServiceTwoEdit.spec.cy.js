...
import { editParentMainServiceTwo, userPassword } from '../../support/configData';
import { onBenchmarksPage } from '../../support/page_objects/onBenchmarksPage';
import { onHomePage } from '../../support/page_objects/onHomePage';

xdescribe('Parent benchmark page, main service 2, as edit user', { tags: '@benchmarks' }, () => {
  beforeEach(() => {
    cy.loginAsUser(editParentMainServiceTwo, userPassword);
